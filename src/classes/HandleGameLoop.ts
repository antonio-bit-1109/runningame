...
export class HandleGameLoop {
    ...
    public levelOne() {
        ...
        if (!costanti.levelFinished) {
            costanti.startObstaclesGeneration = true;
        }
        ...
        // movimento dell ostacolo precedente e disegno di nuovi ostacoli dentro l array degli ostacoli
        moveObstacle()
